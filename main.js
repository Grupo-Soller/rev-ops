        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Desde 2023',
                    font: { size: 16, weight: 'bold' },  color: '#666666'
                },
                legend: {
        labels: {
            color: '#666666' // Define a cor branca na legenda
        }
    },
                tooltip: {
                    callbacks: {
...
function createNichesChart1() {
    const nichesCtx = document.getElementById('nichesChart1');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Marcia Fernandes',
                    data: window.SollerData.niches.quarterly.data1.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Camila Dias',
                    data: window.SollerData.niches.quarterly.data1.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Aline Marquez',
                    data: window.SollerData.niches.quarterly.data1.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Fernanda Cintra',
                    data: window.SollerData.niches.quarterly.data1.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Pedro Novaes',
                    data: window.SollerData.niches.quarterly.data1.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
...
function createNichesChart2() {
    const nichesCtx = document.getElementById('nichesChart2');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Márcia Fernandes',
                    data: window.SollerData.niches.quarterly.data2.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Aline Marquez',
                    data: window.SollerData.niches.quarterly.data2.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Ellen Milgrau',
                    data: window.SollerData.niches.quarterly.data2.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Camila Dias',
                    data: window.SollerData.niches.quarterly.data2.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Carol Peixinho',
                    data: window.SollerData.niches.quarterly.data2.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
...
function createNichesChart3() {
    const nichesCtx = document.getElementById('nichesChart3');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Márcia Fernandes',
                    data: window.SollerData.niches.quarterly.data3.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Ellen Milgrau',
                    data: window.SollerData.niches.quarterly.data3.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Edson Celulari',
                    data: window.SollerData.niches.quarterly.data3.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Carol Peixinho',
                    data: window.SollerData.niches.quarterly.data3.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Aline Marquez',
                    data: window.SollerData.niches.quarterly.data3.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
...
function createNichesChart4() {
    const nichesCtx = document.getElementById('nichesChart4');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Camila Dias',
                    data: window.SollerData.niches.quarterly.data4.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Fernanda Cintra',
                    data: window.SollerData.niches.quarterly.data4.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Gabi Sobral',
                    data: window.SollerData.niches.quarterly.data4.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Duda Guerra',
                    data: window.SollerData.niches.quarterly.data4.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Pedro Novaes',
                    data: window.SollerData.niches.quarterly.data4.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Valor absoluto (2025 menos 2024)',
                    font: { size: 16, weight: 'bold' },  color: '#666666'
                },
                legend: {
        labels: {
...
function createNichesChart5() {
    const nichesCtx = document.getElementById('nichesChart5');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Duda Guerra',
                    data: window.SollerData.niches.quarterly.data5.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Sophia Cit',
                    data: window.SollerData.niches.quarterly.data5.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Bia Napolitano',
                    data: window.SollerData.niches.quarterly.data5.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Fernanda Cintra',
                    data: window.SollerData.niches.quarterly.data5.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Gabi Sobral',
                    data: window.SollerData.niches.quarterly.data5.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Multiplicador (2025 sobre 2024)',
                    font: { size: 16, weight: 'bold' },  color: '#666666'
                },
                legend: {
        labels: {
...
function createNichesChart6() {
    const nichesCtx = document.getElementById('nichesChart6');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Carol Peixinho',
                    data: window.SollerData.niches.quarterly.data6.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Yasmin Castilho',
                    data: window.SollerData.niches.quarterly.data6.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Ellen Milgrau',
                    data: window.SollerData.niches.quarterly.data6.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Marcello Novaes',
                    data: window.SollerData.niches.quarterly.data6.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Gossip do Dia',
                    data: window.SollerData.niches.quarterly.data6.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
...
function createNichesChart7() {
    const nichesCtx = document.getElementById('nichesChart7');
    if (!nichesCtx) {
        console.warn('Canvas nichesChart não encontrado');
        return;
    }
    ...
    nichesCtx.chart = new Chart(nichesCtx.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [
                {
                    label: 'Maria Eugenia',
                    data: window.SollerData.niches.quarterly.data7.moda,
                    borderColor: '#7c3aed',
                    backgroundColor: 'rgba(124, 58, 237, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Carol Peixinho',
                    data: window.SollerData.niches.quarterly.data7.saude,
                    borderColor: '#16a34a',
                    backgroundColor: 'rgba(22, 163, 74, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Bianca Camargo',
                    data: window.SollerData.niches.quarterly.data7.beleza,
                    borderColor: '#dc2626',
                    backgroundColor: 'rgba(220, 38, 38, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Carol e Pippo',
                    data: window.SollerData.niches.quarterly.data7.acessorios,
                    borderColor: '#f59e0b',
                    backgroundColor: 'rgba(245, 158, 11, 0.1)',
                    tension: 0.4
                },
                {
                    label: 'Fernanda Kanner',
                    data: window.SollerData.niches.quarterly.data7.alimentacao,
                    borderColor: '#3b82f6',
                    backgroundColor: 'rgba(59, 130, 246, 0.1)',
                    tension: 0.4
                }
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Multiplicador (2025 [1,9x] sobre 2024)',
                    font: { size: 16, weight: 'bold' },  color: '#666666'
                },
                legend: {
        labels: {
